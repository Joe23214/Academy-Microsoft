    ...
    public class Pcrud : iCrud
    {
        ...
        public string createProdotto(Prodotto p)
        {
            ...
            try
            {
                ...
                "INSERT INTO Prodotti(NOME_PRODOTTO,PREZZO,GIACENZA) VALUES(@NOME,@PREZZO,@GIACENZA)", conn);
        ...
        public List<Prodotto> viewAll()
        {
            ...
            {
                using var cmd = new SqlCommand(
                "SELECT ID, NOME_PRODOTTO,PREZZO,GIACENZA  FROM Prodotti", conn);
                conn.Open();
        ...
        public string updateProdotto(Prodotto pr)
        {
            ...
            try
            {
                ...
                using var cmd = new SqlCommand(
                    "UPDATE Prodotti SET NOME_PRODOTTO = @NOME, PREZZO = @PREZZO, GIACENZA = @GIACENZA WHERE ID = @ID", conn);
