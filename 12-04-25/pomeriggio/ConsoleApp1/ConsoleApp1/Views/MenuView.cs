...
namespace ConsoleApp1.Views
{
    internal class MenuView
    {
        ...
        public MenuView(UniversitàController ctrl, LogService ls)
        {
            controller = ctrl;
            logService = ls;
        }
        ...
        public void Start()
        {
            ...
            while (!exit)
            {
                ...
                Console.WriteLine("20. Abilita/disabilita log per operazioni relative a studenti");
                Console.WriteLine("21. Abilita/disabilita log per operazioni relative a professori");
                Console.WriteLine("22. Abilita/disabilita log per operazioni relative a corsi");
                Console.WriteLine("23. Abilita/disabilita log per operazioni relative a code e storico");
                ...
                switch (Console.ReadLine())
                {
                    ...
                    case "20": ToggleStudenti(); break;
                    case "21": ToggleProfessori(); break;
                    case "22": ToggleCorsi(); break;
                    case "23": ToggleCodeStorico(); break;
                    default:
        ...
        private void ToggleStudenti()
        {
            var logger = Logger.Instance;
            logger.LogStudenti = !logger.LogStudenti;
            logger.SalvaConfigSuDb();
            Console.WriteLine("Log studenti: " + (logger.LogStudenti ? "ABILITATO" : "DISABILITATO"));
        }

        private void ToggleProfessori()
        {
            var logger = Logger.Instance;
            logger.LogProfessori = !logger.LogProfessori;
            logger.SalvaConfigSuDb();
            Console.WriteLine("Log professori: " + (logger.LogProfessori ? "ABILITATO" : "DISABILITATO"));
        }

        private void ToggleCorsi()
        {
            var logger = Logger.Instance;
            logger.LogCorsi = !logger.LogCorsi;
            logger.SalvaConfigSuDb();
            Console.WriteLine("Log corsi: " + (logger.LogCorsi ? "ABILITATO" : "DISABILITATO"));
        }

        private void ToggleCodeStorico()
        {
            var logger = Logger.Instance;
            logger.LogCodeStorico = !logger.LogCodeStorico;
            logger.SalvaConfigSuDb();
            Console.WriteLine("Log code/storico: " + (logger.LogCodeStorico ? "ABILITATO" : "DISABILITATO"));
        }
