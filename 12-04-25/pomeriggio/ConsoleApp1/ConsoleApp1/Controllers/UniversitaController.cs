...
namespace ConsoleApp1
{
    public class UniversitàController
    {
        ...
        public UniversitàController(InterfacciaRepository repository, LogService ls)
        {
            repo = repository;
            logService = ls;
        }
        ...
        public Studente ApprovaRichiesta()
        {
            ...
            if (studente.CorsoIscritto == null)
            {
                Console.WriteLine($"Errore: lo studente {studente.Matricola} non ha un corso assegnato.");
                return null;
            }
        ...
        public bool RichiestaNuovoStudente(string nome, string cognome, string matricola, string codiceCorso)
        {
            ...
            if (corso == null)
            {
                Console.WriteLine("Errore: corso inesistente.");
                return false;
            }

            var studente = new Studente(nome, cognome, matricola, corso);
